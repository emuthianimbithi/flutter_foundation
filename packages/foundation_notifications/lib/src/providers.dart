...
final notificationRouteResolverProvider =
  ...
  throw UnimplementedError(
      'Provide NotificationRouteResolver via ProviderScope overrides.');
});
...
final notificationsPermissionServiceProvider =
    Provider<NotificationsPermissionService>((ref) {
...
final notificationsInitializerProvider =
    Provider<NotificationsInitializer>((ref) {
...
final notificationEventsProvider = StreamProvider<NotificationEvent>((ref) {
  ...
  final sub = router.events.listen(controller.add,
