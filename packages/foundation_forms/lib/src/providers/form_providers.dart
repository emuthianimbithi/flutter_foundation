...
class FoundationFormController extends StateNotifier<FoundationFormState> {
  ...
  void setText(String key, String value, {String? error}) {
    state = state.setField<String>(key, FoundationFormFieldState<String>(value: value, error: error));
  }
}

final foundationFormControllerProvider =
    StateNotifierProvider.autoDispose<FoundationFormController, FoundationFormState>((ref) {
